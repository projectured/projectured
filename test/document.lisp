  ...
  (bind ((chart-page-path (make-adjustable-string "/page"))
         ...
         (server-variable (make-common-lisp/special-variable-definition (make-lisp-form/symbol "*DEMO-SERVER*" "PROJECTURED.TEST")
                                                                        (make-common-lisp/application (make-lisp-form/symbol* 'make-instance)
                                                                                                      (list (make-common-lisp/constant (find-symbol "SERVER" "HU.DWIM.WEB-SERVER"))
                                                                                                            (make-common-lisp/constant :host) (make-common-lisp/constant (find-symbol "+ANY-HOST+" "IOLIB.SOCKETS"))
                                                                                                            (make-common-lisp/constant :port) (make-common-lisp/constant 8080)
                                                                                                            (make-common-lisp/constant :handler)  (make-common-lisp/lambda-function nil (list (make-common-lisp/application (make-lisp-form/symbol "SERVE-HTTP-REQUEST" "HU.DWIM.WEB-SERVER")
                                                                                                                                                                                                                            (list (make-common-lisp/constant 'process-http-request)))))))))
    ...
    (book/book (:title "A Web Service Demo" :authors (list "Levente Mészáros"))
      ...
      (book/chapter (:title "Web Server")
        (book/paragraph ()
          (text/text ()
            (text/string "Evaluating the following Commonn Lisp code creates the web server and stores it in a global variable." :font *font/ubuntu/regular/18* :font-color *color/solarized/content/darker*)))
        server-variable
        (book/paragraph ()
          (text/text ()
        ...
        (make-common-lisp/application (make-lisp-form/symbol "STARTUP-SERVER" "HU.DWIM.WEB-SERVER")
                                      (list (make-common-lisp/variable-reference server-variable)))
        (book/paragraph ()
          (text/text ()
        ...
        (make-common-lisp/application (make-lisp-form/symbol "SHUTDOWN-SERVER" "HU.DWIM.WEB-SERVER")
                                      (list (make-common-lisp/variable-reference server-variable))))
      ...
      (book/chapter (:title "Server Program")
        ...
        (make-evaluator/evaluator process-http-function))
