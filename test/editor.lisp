...
(def test test/editor/book (&key wrap)
  (test/editor/read-eval-print-loop wrap (make-test-document/book) nil (make-test-projection/book->graphics)))
...
(def test test/editor/nested (&key wrap)
  (test/editor/read-eval-print-loop wrap (make-test-document/nested) nil (make-test-projection/nested->graphics)))

(def test test/editor/complex (&key wrap)
  (test/editor/read-eval-print-loop wrap (make-test-document/complex) nil(make-test-projection/complex->graphics)))
...
(def test test/editor/t/cons (&key wrap)
  (test/editor/read-eval-print-loop wrap (make-test-document/t/cons)
                                    '((the sequence-position (pos (the string document) 1))
                                      (the string (elt (the list document) 0))
                                      (the list (content-of (the document document))))
...
(def test test/editor/documentation (&key wrap)
  (test/editor/read-eval-print-loop wrap (make-test-document/documentation) nil (make-test-projection/documentation->graphics)))
