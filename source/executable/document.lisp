...
(def function make-initial-document/web-example ()
  (bind ((chart-page-path (make-adjustable-string "/page"))
         ...
         (trace-amounts (make-common-lisp/comment
                         (text/text ()
                           (text/string "This part contains trace amounts of " :font projectured::*font/ubuntu/regular/24* :font-color *color/solarized/gray*)
         ...
         (dispatch-table (table/table ()
                           (table/row ()
                             (table/cell ()
                               (text/text ()
                                 (text/string "HTTP request" :font *font/ubuntu/monospace/bold/24* :font-color *color/solarized/content/darker*)))
                             (table/cell ()
                               (text/text ()
                                 (text/string "HTTP response" :font *font/ubuntu/monospace/bold/24* :font-color *color/solarized/content/darker*))))
                           (table/row ()
                             (table/cell ()
                               (text/text ()
                                 (text/string chart-page-path :font-color *color/solarized/blue*)))
                             (table/cell ()
                               (text/text ()
                                 (text/string "the HTML page that contains the pie chart" :font-color *color/solarized/content/darker*))))
                           (table/row ()
                             (table/cell ()
                               (text/text ()
                                 (text/string chart-css-path :font-color *color/solarized/blue*)))
                             (table/cell ()
                               (text/text ()
                                 (text/string "the CSS stylesheet that defines the page style" :font-color *color/solarized/content/darker*))))
                           (table/row ()
                             (table/cell ()
                               (text/text ()
                                 (text/string chart-script-path :font-color *color/solarized/blue*)))
                             (table/cell ()
                               (text/text ()
                                 (text/string "the JavaScript that dynamically creates the pie chart" :font-color *color/solarized/content/darker*))))
                           (table/row ()
                             (table/cell ()
                               (text/text ()
                                 (text/string chart-data-path :font-color *color/solarized/blue*)))
                             (table/cell ()
                               (text/text ()
                                 (text/string "the JSON data that is displayed by the pie chart" :font-color *color/solarized/content/darker*))))
                           (table/row ()
                             (table/cell ()
                               (text/text ()
                                 (text/string "<otherwise>" :font-color *color/solarized/blue*)))
                             (table/cell ()
                               (text/text ()
                                 (text/string "the HTML error page" :font-color *color/solarized/content/darker*))))))
    ...
    (book/book (:title "A Web Service Demo" :author "Levente Mészáros")
      (book/chapter (:title "Problem Description")
        (book/paragraph ()
          (text/text ()
            (text/normal "This example demonstrates mixing multiple different problem domains in the same document. It contains the following: ")))
        (book/list ()
          (book/paragraph ()
            (text/text ()
              (text/normal "a ")
          ...
          (book/paragraph ()
            (text/text ()
              (text/normal "some ")
              (text/emphasis "HTML")
              (text/normal "web pages")))
          (book/paragraph ()
            (text/text ()
              (text/normal "a style sheet in ")
              (text/emphasis "CSS")
              (text/normal " format")))
          (book/paragraph ()
            (text/text ()
          ...
          (book/paragraph ()
            (text/text ()
              (text/normal "a ")
              (text/emphasis "table")
              (text/normal " expressing a the cases")))
          (book/paragraph ()
            (text/text ()
              (text/normal "an ")
              (text/emphasis "image")
              (text/normal "showing the end result")))
          (book/paragraph ()
            (text/text ()
              (text/normal "some ")
              (text/emphasis "styled text"))))
        (book/paragraph ()
          (text/text ()
            (text/normal "It describes a web service implemented as a single Common Lisp function that processes HTTP requests. When the function receives a request to the '")
