...
(def function make-workbench-document (documents)
  (bind ((editing-page (make-workbench/page documents :selection '((the sequence (elements-of (the workbench/page document)))
    ...
    (workbench/workbench (:selection '((the workbench/page (editing-page-of (the workbench/workbench document)))))
      ...
      (workbench/page (:selection '((the sequence (elements-of (the workbench/page document)))
                                    (the workbench/navigator (elt (the sequence document) 0))))
        (workbench/descriptor () (as (document/reference () (get-selection editing-page))))
        (workbench/console ()
          (text/text ()
...
(def function make-default-document (documents)
  (make-workbench-document documents))
