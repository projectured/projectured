...
(def function text/make-process-text (content &optional (keywords '("ProjecturEd" "Google" "Charts" "API" "HTTP" "HTML" "DIV" "URL" "CSS" "JSON" "JavaScript" "Common Lisp" "write-string")))
...
(def function make-initial-document/web-example ()
  (bind ((chart-page-path (make-adjustable-string "/page"))
    ...
    (book/book (:title "Creating a Simple Web Page with ProjecturEd" :author "Levente Mészáros")
      (book/chapter (:title "Introduction")
        (book/paragraph (:alignment :justified)
          (text/make-process-text "ProjecturEd is a general purpose projectional editor that provides editing for arbitrary structured documents. This document demonstrates the features of projectional editing in the context of computer programming.")))
      (book/chapter (:title "Description of the Task")
        (book/paragraph (:alignment :justified)
          (text/make-process-text "The programming task is to implement a single web page that contains a pie chart. The pie chart displays the amount of time spent with a few daily activities.")))
      ...
      (book/chapter (:title "Error Page")
        ...
        (book/paragraph (:alignment :justified)
          (text/make-process-text "The following is the complete web page including the required head and the body elements. It reuses the previous definition of the error message, so editing is reflected in both of them."))
        (book/paragraph ()
      ...
      (book/chapter (:title "Putting it All Together in the Server Program")
        ...
        (book/paragraph (:alignment :justified)
          (text/make-process-text "The server program can be compiled by the Common Lisp compiler using another projection. The result of this projection is similar to the ones presented earlier.")))
