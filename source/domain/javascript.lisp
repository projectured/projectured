...
(def function make-javascript/statement/block (elements)
  (make-instance 'javascript/statement/block :elements elements))

(def function make-javascript/statement/top-level (elements)
  (make-instance 'javascript/statement/top-level :elements elements))

;;;;;;
;;; Javascript expression constructors

(def function make-javascript/expression/variable-reference (name)
  (make-instance 'javascript/expression/variable-reference :name name))

(def function make-javascript/expression/property-access (object property)
  (make-instance 'javascript/expression/property-access :object object :property property))

(def function make-javascript/expression/constuctor-invocation (object arguments)
  (make-instance 'javascript/expression/constructor-invocation :object object :arguments arguments))

(def function make-javascript/expression/method-invocation (object method arguments)
...
(def function make-javascript/literal/boolean (value)
  (make-instance 'javascript/literal/boolean :value value))

(def function make-javascript/literal/number (value)
  (make-instance 'javascript/literal/number :value value))

(def function make-javascript/literal/string (value)
  (make-instance 'javascript/literal/string :value value))

;;;;;;
;;; Javascript definition constructors

(def function make-javascript/definition/variable (name body)
  (make-instance 'javascript/definition/variable
                 :name name
                 :body body))

(def function make-javascript/definition/function (name arguments body)
