...
(def forward-mapper common-lisp/insertion->lisp-form/insertion ()
...
(def forward-mapper common-lisp/constant->lisp-form/string ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/the->lisp-form/list ()
  (pattern-case -reference-
    (((the lisp-form/list (printer-output (the common-lisp/the document) ?projection ?recursion)) . ?rest)
     (when (eq -projection- ?projection)
       ?rest))))

(def forward-mapper common-lisp/progn->lisp-form/list ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/lexical-variable-binding->lisp-form/list ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/let->lisp-form/list ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/application->lisp-form/list ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/special-variable-definition->lisp-form/list ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/function-definition->lisp-form/list ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/lambda-function->lisp-form/list ()
  (pattern-case -reference-
    (((the lisp-form/list (printer-output (the common-lisp/lambda-function document) ?projection ?recursion)) . ?rest)
     (when (eq -projection- ?projection)
       ?rest))))

(def forward-mapper common-lisp/function-argument->lisp-form/symbol ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/comment->lisp-form/comment ()
  (pattern-case -reference-
...
(def forward-mapper common-lisp/toplevel->lisp-form/toplevel ()
  (pattern-case -reference-
...
(def backward-mapper common-lisp/insertion->lisp-form/insertion ()
  (pattern-case -reference-
    (((the string (value-of (the lisp-form/insertion document)))
      (the string (subseq (the string document) ?start-index ?end-index)))
     `((the string (value-of (the common-lisp/insertion document)))
...
(def backward-mapper common-lisp/constant->lisp-form/string ()
...
(def backward-mapper common-lisp/variable-reference->lisp-form/symbol ()
...
(def backward-mapper common-lisp/function-reference->lisp-form/symbol ()
...
(def backward-mapper common-lisp/if->lisp-form/list ()
  (pattern-case -reference-
    (((the lisp-form/list document))
     `((the common-lisp/if document)))
    (((the sequence (elements-of (the lisp-form/list document)))
...
(def backward-mapper common-lisp/the->lisp-form/list ()
  (pattern-case -reference-
    (?a
     (append `((the lisp-form/list (printer-output (the common-lisp/the document) ,-projection- ,-recursion-))) -reference-))))

(def backward-mapper common-lisp/progn->lisp-form/list ()
  (pattern-case -reference-
    (((the lisp-form/list document))
     `((the common-lisp/progn document)))
    (((the sequence (elements-of (the lisp-form/list document)))
...
(def backward-mapper common-lisp/lexical-variable-binding->lisp-form/list ()
  (pattern-case -reference-
    (((the sequence (elements-of (the lisp-form/list document)))
      (the lisp-form/symbol (elt (the sequence document) 0))
      . ?rest)
...
(def backward-mapper common-lisp/let->lisp-form/list ()
  (pattern-case -reference-
    (((the sequence (elements-of (the lisp-form/list document)))
      (the lisp-form/list (elt (the sequence document) 1))
      (the sequence (elements-of (the lisp-form/list document)))
...
(def backward-mapper common-lisp/application->lisp-form/list ()
  (pattern-case -reference-
    (((the lisp-form/list document))
     `((the common-lisp/application document)))
    (((the sequence (elements-of (the lisp-form/list document)))
...
(def backward-mapper common-lisp/special-variable-definition->lisp-form/list ()
  (pattern-case -reference-
    (((the sequence (elements-of (the lisp-form/list document)))
      (the lisp-form/symbol (elt (the sequence document) 1))
      (the string (name-of (the lisp-form/symbol document)))
...
(def backward-mapper common-lisp/function-definition->lisp-form/list ()
  (pattern-case -reference-
    (((the lisp-form/list document))
     `((the common-lisp/function-definition document)))
    (((the sequence (elements-of (the lisp-form/list document)))
...
(def backward-mapper common-lisp/lambda-function->lisp-form/list ()
  (pattern-case -reference-
    (?a
     (append `((the lisp-form/list (printer-output (the common-lisp/lambda-function document) ,-projection- ,-recursion-))) -reference-))))

(def backward-mapper common-lisp/function-argument->lisp-form/symbol ()
  (pattern-case -reference-
    (((the string (name-of (the lisp-form/symbol document)))
      (the string (subseq (the string document) ?start-index ?end-index)))
     `((the lisp-form/symbol (name-of (the common-lisp/function-argument document)))
...
(def backward-mapper common-lisp/comment->lisp-form/comment ()
  (pattern-case -reference-
    (((the text/text (content-of (the lisp-form/comment document)))
      (the text/text (text/subseq (the text/text document) ?start-index ?end-index)))
     `((the text/text (content-of (the common-lisp/comment document)))
...
(def backward-mapper common-lisp/toplevel->lisp-form/toplevel ()
  (pattern-case -reference-
...
(def printer common-lisp/insertion->lisp-form/insertion ()
...
(def printer common-lisp/constant->lisp-form/string ()
  (bind ((output-selection (as (print-selection (make-iomap -projection- -recursion- -input- -input-reference- nil)
                                                (get-selection -input-)
...
(def printer common-lisp/variable-reference->lisp-form/symbol ()
...
(def printer common-lisp/function-reference->lisp-form/symbol ()
  (bind ((output-selection (as (pattern-case (get-selection -input-)
...
(def printer common-lisp/if->lisp-form/list ()
  (bind ((condition-iomap (as (recurse/slot -recursion- -input- 'condition -input-reference-)))
         ...
         (output (as (make-lisp-form/list (append (list (make-lisp-form/symbol* 'if :font-color *color/solarized/blue*
...
(def printer common-lisp/the->lisp-form/list ()
...
(def printer common-lisp/progn->lisp-form/list ()
...
(def printer common-lisp/lexical-variable-binding->lisp-form/list ()
  (bind ((value-iomap (as (recurse/slot -recursion- -input- 'value -input-reference-)))
...
(def printer common-lisp/let->lisp-form/list ()
...
(def printer common-lisp/application->lisp-form/list ()
  (bind ((argument-iomaps (as (when (arguments-of -input-)
         ...
         (output (as (bind ((operator (operator-of -input-))
                       ...
                       (make-lisp-form/list (append-ll (list-ll (list-ll (make-lisp-form/symbol operator-name operator-package :default-value "enter function name" :font-color *color/solarized/violet*
                                                                                                :selection (as (pattern-case (va output-selection)
                                                                                                                 (((the sequence (elements-of (the lisp-form/list document)))
                                                                                                                   (the lisp-form/symbol (elt (the sequence document) 0))
                                                                                                                   . ?rest)
...
(def printer common-lisp/special-variable-definition->lisp-form/list ()
  (bind ((value-iomap (as (recurse/slot -recursion- -input- 'value -input-reference-)))
         (output-selection (as (print-selection (make-iomap/compound -projection- -recursion- -input- -input-reference- nil (as (list (va value-iomap))))
                                                (get-selection -input-)
...
(def printer common-lisp/function-definition->lisp-form/list ()
  (bind ((binding-iomaps (as (recurse/ordinary-lambda-list -recursion- -input- -input-reference-)))
         ...
         (output (as (bind ((documentation (documentation-of -input-))
                       ...
                       (make-lisp-form/list (append (list (make-lisp-form/symbol* 'defun :font-color *color/solarized/blue*
                                                                                  :selection (as (pattern-case (va output-selection)
                                                                                                   (((the sequence (elements-of (the lisp-form/list document)))
                                                                                                     (the lisp-form/symbol (elt (the sequence document) 0))
                                                                                                     . ?rest)
                                                                                                    (nthcdr 2 (va output-selection))))))
                                                          (make-lisp-form/symbol (name-of function-name) (package-of function-name) :default-value "enter function name" :font *font/ubuntu/monospace/italic/24* :font-color *color/solarized/violet*
                                                                                 :selection (as (pattern-case (va output-selection)
                                                                                                  (((the sequence (elements-of (the lisp-form/list document)))
                                                                                                    (the lisp-form/symbol (elt (the sequence document) 1))
                                                                                                    . ?rest)
                                                          ...
                                                          (make-lisp-form/list (mapcar 'output-of (va binding-iomaps))
                                                                               :selection (as (pattern-case (va output-selection)
                                                                                                (((the sequence (elements-of (the lisp-form/list document)))
                                                                                                  ...
                                                                                                  . ?rest)
                                                                                                 (nthcdr 2 (va output-selection)))))))
                                                    (when documentation (list (make-lisp-form/string documentation :default-value "enter function documentation" :indentation 2
                                                                                                     :selection (as (pattern-case (va output-selection)
                                                                                                                      (((the sequence (elements-of (the lisp-form/list document)))
                                                                                                                        (the lisp-form/string (elt (the sequence document) 3))
                                                                                                                        . ?rest)
...
(def printer common-lisp/lambda-function->lisp-form/list ()
  (bind ((binding-iomaps (as (recurse/ordinary-lambda-list -recursion- -input- -input-reference-)))
         (body-iomaps (as (recurse/slot -recursion- -input- 'body -input-reference-)))
...
(def printer common-lisp/function-argument->lisp-form/symbol ()
  (bind ((output-selection (as (print-selection (make-iomap -projection- -recursion- -input- -input-reference- nil)
                                                (get-selection -input-)
...
(def printer common-lisp/comment->lisp-form/comment ()
...
(def printer common-lisp/toplevel->lisp-form/toplevel ()
  (bind ((body-iomaps (as (recurse/slot -recursion- -input- 'body -input-reference-)))
         (output-selection (as (print-selection (make-iomap/compound -projection- -recursion- -input- -input-reference- nil body-iomaps)
                                                (get-selection -input-)
                                                'forward-mapper/common-lisp/toplevel->lisp-form/toplevel)))
         (output (as (make-lisp-form/toplevel (map-ll (va body-iomaps) (lambda (element)
                                                                         (bind ((output (output-of element)))
                                                                           (etypecase output
                                                                             (lisp-form/base (lisp-form/clone output :indentation 0))
                                                                             (tree/base (tree/clone output :indentation 0))))))
                                              :selection output-selection))))
    (make-iomap/compound -projection- -recursion- -input- -input-reference- output body-iomaps)))
...
(def reader common-lisp/insertion->lisp-form/insertion ()
...
(def reader common-lisp/constant->lisp-form/string ()
...
(def reader common-lisp/variable-reference->lisp-form/symbol ()
...
(def reader common-lisp/function-reference->lisp-form/symbol ()
...
(def reader common-lisp/if->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/the->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/progn->lisp-form/list ()
...
(def reader common-lisp/lexical-variable-binding->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/let->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/application->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/special-variable-definition->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/function-definition->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/lambda-function->lisp-form/list ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/function-argument->lisp-form/symbol ()
...
(def reader common-lisp/comment->lisp-form/comment ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
...
(def reader common-lisp/toplevel->lisp-form/toplevel ()
  (merge-commands (common-lisp/read-expression-command -printer-iomap- -gesture-)
