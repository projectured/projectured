      ...
      (((the ?type (?reader (the common-lisp/if document)))
       ...
       (bind ((slot-iomap (elt (child-iomaps-of printer-iomap)
              ...
              (index (ecase ?reader
                       ...
                       (then-of 2)
                       (else-of 3))))
         (values `((the ,(form-type slot-output) (elt (the sequence document) ,index))
    ...
    (pattern-case (reverse reference)
      (((the sequence (body-of (the common-lisp/progn document)))
       ...
       (bind ((element-iomap (elt (child-iomaps-of printer-iomap) ?index))
         ...
         (values `((the ,(form-type element-output) (elt (the sequence document) ,(1+ ?index)))
                   (the sequence (elements-of (the lisp-form/list document))))
                 (reverse ?rest)
                 element-iomap)))
  ...
  (bind ((projection (projection-of printer-iomap))
    ...
    (pattern-case (reverse reference)
      (((the lisp-form/symbol (name-of (the common-lisp/lexical-variable-binding document)))
        . ?rest)
       (reverse `((the sequence (elements-of (the lisp-form/list document)))
      ...
      (((the ?type (value-of (the common-lisp/lexical-variable-binding document)))
       ...
       (bind ((value-iomap (elt (child-iomaps-of printer-iomap) 0))
         ...
         (values `((the ,(form-type value) (elt (the sequence document) 1))
                   (the sequence (elements-of (the lisp-form/list document))))
                 (reverse ?rest)
                 value-iomap)))
    ...
    (pattern-case (reverse reference)
      (((the sequence (bindings-of (the common-lisp/let document)))
       ...
       (bind ((binding-iomap (elt (child-iomaps-of printer-iomap) ?index)))
         (values `((the lisp-form/list (elt (the sequence document) ,?index))
                   (the sequence (elements-of (the lisp-form/list document)))
      ...
      (((the sequence (body-of (the common-lisp/let document)))
       ...
       (bind ((body-element-iomap (elt (child-iomaps-of printer-iomap) (+ ?index (length (bindings-of printer-input)))))
         ...
         (values `((the ,(form-type body-element) (elt (the sequence document) ,(+ ?index 2)))
                   (the sequence (elements-of (the lisp-form/list document))))
                 (reverse ?rest)
                 body-element-iomap)))
    ...
    (pattern-case (reverse reference)
      ...
      (((the sequence (arguments-of (the common-lisp/application document)))
       ...
       (bind ((argument-iomap (elt (child-iomaps-of printer-iomap) ?index))
         ...
         (values `((the ,(form-type argument-output) (elt (the sequence document) ,(1+ ?index)))
                   (the sequence (elements-of (the lisp-form/list document))))
                 (reverse ?rest)
                 argument-iomap)))
  ...
  (bind ((projection (projection-of printer-iomap))
    ...
    (pattern-case (reverse reference)
      ...
      (((the ?value-type (value-of (the common-lisp/special-variable-definition document)))
       ...
       (bind ((value-iomap (elt (child-iomaps-of printer-iomap) 0))
              (value (output-of value-iomap)))
         (values `((the ,(form-type value) (elt (the sequence document) 2))
                   (the sequence (elements-of (the lisp-form/list document))))
                 (reverse ?rest)
                 value-iomap)))
    ...
    (pattern-case (reverse reference)
      ...
      (((the sequence (bindings-of (the common-lisp/function-definition document)))
       ...
       (bind ((iomap-index ?index)
         ...
         (values `((the ,(form-type binding-output) (elt (the sequence document) ,?index))
                   (the sequence (elements-of (the lisp-form/list document)))
      ...
      (((the sequence (body-of (the common-lisp/function-definition document)))
       ...
       (bind ((iomap-index (+ (length (bindings-of printer-input)) ?index))
         ...
         (values `((the ,(form-type body-output) (elt (the sequence document) ,(+ ?index 4)))
                   (the sequence (elements-of (the lisp-form/list document))))
                 (reverse ?rest)
                 body-iomap)))
    ...
    (pattern-case (reverse reference)
      (((the string (value-of (the lisp-form/insertion document)))
       ...
       `((the string (subseq (the string document) ,?start-index ,?end-index))
         (the string (value-of (the common-lisp/insertion document)))))
      (?a
       (append reference `((the lisp-form/insertion (printer-output (the common-lisp/insertion document) ,projection ,recursion))))))))
...
(def function backward-mapper/common-lisp/constant->lisp-form/string (printer-iomap reference)
  (bind ((projection (projection-of printer-iomap))
    ...
    (pattern-case (reverse reference)
      ...
      (?a
       (append reference `((the lisp-form/string (printer-output (the common-lisp/constant document) ,projection ,recursion))))))))
...
(def function backward-mapper/common-lisp/variable-reference->lisp-form/symbol (printer-iomap reference)
  (bind ((projection (projection-of printer-iomap))
    ...
    (pattern-case (reverse reference)
      ...
      (?a
       (append reference `((the lisp-form/symbol (printer-output (the common-lisp/variable-reference document) ,projection ,recursion))))))))
...
(def function backward-mapper/common-lisp/function-reference->lisp-form/symbol (printer-iomap reference)
  (bind ((projection (projection-of printer-iomap))
    ...
    (pattern-case (reverse reference)
      ...
      (?a
       (append reference `((the lisp-form/symbol (printer-output (the common-lisp/function-reference document) ,projection ,recursion))))))))
      ...
      (((the sequence (elements-of (the lisp-form/list document)))
       ...
       (bind ((slot-reader (ecase ?index
         ...
         (values `((the ,(form-type slot-value) (,slot-reader (the common-lisp/if document))))
                 ...
                 element-iomap)))
      (?a
       (append reference `((the lisp-form/list (printer-output (the common-lisp/if document) ,projection ,recursion))))))))
      ...
      (((the sequence (elements-of (the lisp-form/list document)))
       ...
       (bind ((element-index (1- ?index))
         ...
         (values `((the ,(form-type element) (elt (the sequence document) ,element-index))
                 ...
                 element-iomap)))
      (?a
       (append reference `((the lisp-form/list (printer-output (the common-lisp/progn document) ,projection ,recursion))))))))
  ...
  (bind ((projection (projection-of printer-iomap))
    ...
    (pattern-case (reverse reference)
      (((the sequence (elements-of (the lisp-form/list document)))
        (the lisp-form/symbol (elt (the sequence document) 0))
        . ?rest)
       (reverse `((the lisp-form/symbol (name-of (the common-lisp/lexical-variable-binding document)))
                  ,@?rest)))
      (((the sequence (elements-of (the lisp-form/list document)))
       ...
       (bind ((value-iomap (elt (child-iomaps-of printer-iomap) 0)))
         (values `((the ,(form-type (value-of printer-input)) (value-of (the common-lisp/lexical-variable-binding document))))
                 ...
                 value-iomap)))
      (?a
       (append reference `((the lisp-form/list (printer-output (the common-lisp/lexical-variable-binding document) ,projection ,recursion))))))))
  ...
  (bind ((projection (projection-of printer-iomap))
    ...
    (pattern-case (reverse reference)
      (((the sequence (elements-of (the lisp-form/list document)))
        ...
        . ?rest)
       (bind ((binding-iomap (elt (child-iomaps-of printer-iomap) ?index)))
         (values `((the common-lisp/lexical-variable-binding (elt (the sequence document) ,?index))
                   (the sequence (bindings-of (the common-lisp/let document))))
                 (reverse ?rest)
                 binding-iomap)))
      (((the sequence (elements-of (the lisp-form/list document)))
        ...
        . ?rest)
       (if (zerop ?index)
           (append reference `((the lisp-form/list (printer-output (the common-lisp/let document) ,projection ,recursion))))
           (bind ((index (- ?index 2))
             ...
             (values `((the ,(form-type body-element) (elt (the sequence document) ,index))
                       (the sequence (body-of (the common-lisp/let document))))
                     (reverse ?rest)
                     body-element-iomap))))
      (?a
    ...
    (pattern-case (reverse reference)
      ...
      (((the sequence (elements-of (the lisp-form/list document)))
       ...
       (bind ((argument-index (1- ?index))
         ...
         (values `((the ,(form-type argument) (elt (the sequence document) ,argument-index))
                   (the sequence (arguments-of (the common-lisp/application document))))
                 (reverse ?rest)
                 child-iomap)))
      (?a
       (append reference `((the lisp-form/list (printer-output (the common-lisp/application document) ,projection ,recursion))))))))
      ...
      (((the sequence (elements-of (the lisp-form/list document)))
       ...
       (bind ((value (value-of printer-input))
         ...
         (values `((the ,(form-type value) (value-of (the common-lisp/special-variable-definition document))))
                 ...
                 value-iomap)))
      (?a
       (append reference `((the lisp-form/list (printer-output (the common-lisp/special-variable-definition document) ,projection ,recursion))))))))
              ...
              (pattern-case ?rest
                (((the sequence (elements-of (the lisp-form/list document)))
                 ...
                 (bind ((binding (elt (bindings-of printer-input) ?binding-index))
                   ...
                   (values `((the ,(form-type binding) (elt (the sequence document) ,?binding-index))
                             (the sequence (bindings-of (the common-lisp/function-definition document))))
                           (reverse ?rest)
                           child-iomap)))
                (?a
                 (append reference `((the lisp-form/list (printer-output (the common-lisp/function-definition document) ,projection ,recursion)))))))
             ((>= ?element-index 4)
              (bind ((element-index (- ?element-index 4))
                ...
                (values `((the ,(form-type element) (elt (the sequence document) ,element-index))
                        ...
                        (reverse ?rest)
                        child-iomap)))
             (t (append reference `((the lisp-form/list (printer-output (the common-lisp/function-definition document) ,projection ,recursion)))))))
      (?a
       (append reference `((the lisp-form/list (printer-output (the common-lisp/function-definition document) ,projection ,recursion))))))))
    ...
    (pattern-case (reverse reference)
      (((the string (name-of (the lisp-form/symbol document)))
       ...
       `((the string (subseq (the string document) ,?start-index ,?end-index))
         ...
         (the lisp-form/symbol (name-of (the common-lisp/function-argument document)))))
      (?a
       (append reference `((the lisp-form/symbol (printer-output (the common-lisp/function-argument document) ,projection ,recursion))))))))
  ...
  (bind ((condition-iomap (as (recurse/slot recursion input 'condition input-reference)))
         ...
         (output-selection (as (pattern-case (reverse (selection-of input))
                                 ...
                                 (((the lisp-form/list (printer-output (the common-lisp/if document) ?projection ?recursion)) . ?rest)
                                  (when (and (eq projection ?projection) (eq recursion ?recursion))
                                    (reverse ?rest))))))
         (output (as (make-lisp-form/list (list* (make-lisp-form/symbol* 'if :font-color *color/solarized/blue* :selection (as (butlast (va output-selection) 2)))
  ...
  (bind ((body-iomaps (as (recurse/slot recursion input 'body input-reference)))
         (output-selection (as (pattern-case (reverse (selection-of input))
                                 ...
                                 (((the lisp-form/list (printer-output (the common-lisp/progn document) ?projection ?recursion)) . ?rest)
                                  (when (and (eq projection ?projection) (eq recursion ?recursion))
                                    (reverse ?rest))))))
         (output (as (make-lisp-form/list (list* (make-lisp-form/symbol* 'progn :font-color *color/solarized/blue* :selection (as (butlast (va output-selection) 2)))
...
(def printer common-lisp/lexical-variable-binding->lisp-form/list (projection recursion input input-reference)
  (bind ((value-iomap (as (recurse/slot recursion input 'value input-reference)))
         ...
         (output (as (bind ((variable-name (name-of input)))
                       (make-lisp-form/list (list (make-lisp-form/symbol (name-of variable-name) (package-of variable-name) :selection (as (butlast (va output-selection) 2)) :font *font/ubuntu/monospace/italic/18* :font-color *color/solarized/red*)
                                                  (output-of (va value-iomap)))
                                            :selection output-selection)))))
...
(def printer common-lisp/let->lisp-form/list (projection recursion input input-reference)
  (bind ((binding-iomaps (as (recurse/slot recursion input 'bindings input-reference)))
         ...
         (output (as (make-lisp-form/list (list* (make-lisp-form/symbol* 'let :selection (as (butlast (va output-selection) 2)) :font-color *color/solarized/blue*)
...
(def printer common-lisp/application->lisp-form/list (projection recursion input input-reference)
  (bind ((argument-iomaps (as (when (arguments-of input)
         ...
         (output (as (bind ((operator (operator-of input))
                       ...
                       (make-lisp-form/list (cons (make-lisp-form/symbol operator-name operator-package :default-value "enter function name" :font-color *color/solarized/violet* :selection (as (butlast (va output-selection) 2)))
...
(def printer common-lisp/special-variable-definition->lisp-form/list (projection recursion input input-reference)
  (bind ((value-iomap (as (recurse/slot recursion input 'value input-reference)))
         ...
         (output (as (bind ((variable-name (name-of input)))
                       (make-lisp-form/list (list (make-lisp-form/symbol* 'defvar :font-color *color/solarized/blue* :selection (as (butlast (va output-selection) 2)))
                                                  (make-lisp-form/symbol (name-of variable-name) (package-of variable-name) :font *font/ubuntu/monospace/italic/18* :font-color *color/solarized/violet* :selection (as (butlast (va output-selection) 2)))
...
(def printer common-lisp/function-definition->lisp-form/list (projection recursion input input-reference)
  (bind ((binding-iomaps (as (recurse/ordinary-lambda-list recursion input input-reference)))
         ...
         (output (as (bind ((documentation (documentation-of input))
                       ...
                       (make-lisp-form/list (append (list (make-lisp-form/symbol* 'defun :font-color *color/solarized/blue* :selection (as (butlast (va output-selection) 2)))
                                                          (make-lisp-form/symbol (name-of function-name) (package-of function-name) :default-value "enter function name" :font *font/ubuntu/monospace/italic/18* :font-color *color/solarized/violet* :selection (as (butlast (va output-selection) 2)))
                                                          (make-lisp-form/list (mapcar 'output-of (va binding-iomaps)) :selection nil #+nil(as (butlast (va output-selection) 2))))
                                                    (when documentation (list (make-lisp-form/string documentation :default-value "enter function documentation" :indentation 2 :selection (as (butlast (va output-selection) 2)))))
                                                    (iter (for body-iomap :in-sequence (va body-iomaps))
                                                          (for body-output = (output-of body-iomap))
                                                          ;; KLUDGE:
                                                          (when (typep body-output '(or tree/base lisp-form/base))
...
(def printer common-lisp/function-argument->lisp-form/symbol (projection recursion input input-reference)
  (bind ((output-selection (as (print-selection (make-iomap/object projection recursion input input-reference nil)
         ...
         (output (as (bind ((name (name-of input)))
                       (make-lisp-form/symbol (name-of name) (package-of name) :default-value "enter argument name" :selection output-selection :font *font/ubuntu/monospace/italic/18* :font-color *color/solarized/red*)))))
    (make-iomap/object projection recursion input input-reference output)))
                       ...
                       :operation (bind (((:values nil completion) (funcall (factory-of printer-input) (value-of printer-input)))
                                    ...
                                    (when completion
                                      (make-operation/sequence/replace-range printer-input `((the string (subseq (the string document) ,end ,end))
                                                                                             (the string (value-of (the common-lisp/insertion document)))) completion))))
                    ...
                    (gesture-case (gesture-of input)
                      ((gesture/keyboard/key-press :sdl-key-insert)
                       ...
                       :operation (bind ((body-length (length (body-of printer-input))))
                                    (make-operation/compound (list (make-operation/sequence/replace-range printer-input `((the sequence (subseq (the sequence document) ,body-length ,body-length))
                    ...
                    (gesture-case (gesture-of input)
                      ((gesture/keyboard/key-press #\( :shift)
                       ...
                       :operation (bind ((arguments-length (length (arguments-of printer-input))))
                                    (make-operation/compound (list (make-operation/sequence/replace-range printer-input `((the sequence (subseq (the sequence document) ,arguments-length ,arguments-length))
                                                                                                                          (the sequence (arguments-of (the common-lisp/application document))))
                      ...
                      ((gesture/keyboard/key-press :sdl-key-insert)
                       ...
                       :operation (bind ((argument-length (length (arguments-of printer-input))))
                                    (make-operation/compound (list (make-operation/sequence/replace-range printer-input `((the sequence (subseq (the sequence document) ,argument-length ,argument-length))
