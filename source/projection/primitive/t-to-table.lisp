...
(def printer t/sequence->table/table (projection recursion input input-reference)
  (bind ((element-iomaps nil)
         ...
         (output (make-table/table (list* (table/row ()
                                            (table/cell ()
                                              (text/text ()
                                                (text/string (object-class-label input) :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/blue*)))
                                            (table/cell ()
                                              (text/text ()
                                          ...
                                          (iter (for index :from 0)
                                                ...
                                                (for index-text = (text/text ()
                                                                    (text/string index-string :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/blue*)))
...
(def printer t/hash-table->table/table (projection recursion input input-reference)
  ;; TODO:
  (bind ((output (text/text () (text/string "hash table" :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/gray*))))
    (make-iomap/object projection recursion input input-reference output)))

(def printer t/function->table/table (projection recursion input input-reference)
  (bind ((output (text/text () (text/string "function" :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/gray*))))
    (make-iomap/object projection recursion input input-reference output)))
         ...
         (output (make-table/table (list* (table/row ()
                                          ...
                                          (iter (with class = (class-of input))
                                                ...
                                                (collect (table/row ()
                                                           (table/cell ()
                                                             (text/text ()
                                                               (text/string (symbol-name (slot-definition-name slot)) :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/blue*)))
                                                           (table/cell ()
                                                             (if slot-bound?
                                                                 (output-of slot-iomap)
                                                                 (text/text ()
                                                                   (text/string "<unbound>" :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/gray*)))))))))))
    (make-iomap/compound projection recursion input input-reference output
                         (append (list (make-iomap/object projection recursion input input-reference output))
                                 (nreverse child-iomaps)
