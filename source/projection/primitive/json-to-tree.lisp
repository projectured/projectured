...
(def forward-mapper json/insertion->tree/leaf ()
...
(def forward-mapper json/null->tree/leaf ()
  (pattern-case -reference-
...
(def forward-mapper json/boolean->tree/leaf ()
  (pattern-case -reference-
...
(def forward-mapper json/number->tree/leaf ()
  (pattern-case -reference-
...
(def forward-mapper json/string->tree/leaf ()
  (pattern-case -reference-
...
(def forward-mapper json/array->tree/node ()
  (pattern-case -reference-
...
(def forward-mapper json/object-entry->tree/node ()
  (pattern-case -reference-
...
(def forward-mapper json/object->tree/node ()
  (pattern-case -reference-
...
(def backward-mapper json/insertion->tree/leaf ()
  (pattern-case -reference-
    (((the text/text (content-of (the tree/leaf document)))
      (the text/text (text/subseq (the text/text document) 0 0)))
     `((the string (value-of (the json/insertion document)))
...
(def backward-mapper json/null->tree/leaf ()
  (pattern-case -reference-
    (((the tree/leaf document))
     '((the json/null document)))
    (((the text/text (content-of (the tree/leaf document)))
...
(def backward-mapper json/boolean->tree/leaf ()
  (pattern-case -reference-
    (((the tree/leaf document))
     '((the json/boolean document)))
    (((the text/text (content-of (the tree/leaf document)))
...
(def backward-mapper json/number->tree/leaf ()
  (pattern-case -reference-
    (((the tree/leaf document))
     '((the json/number document)))
    (((the text/text (content-of (the tree/leaf document)))
...
(def backward-mapper json/string->tree/leaf ()
  (pattern-case -reference-
    (((the tree/leaf document))
     '((the json/string document)))
    (((the text/text (content-of (the tree/leaf document)))
...
(def backward-mapper json/array->tree/node ()
  (pattern-case -reference-
    (((the tree/node document))
     '((the json/array document)))
    (((the sequence (children-of (the tree/node document)))
...
(def backward-mapper json/object-entry->tree/node ()
  (pattern-case -reference-
    (((the tree/node document))
     '((the json/object-entry document)))
    (((the sequence (children-of (the tree/node document)))
...
(def backward-mapper json/object->tree/node ()
  (pattern-case -reference-
    (((the tree/node document))
     '((the json/object document)))
    (((the sequence (children-of (the tree/node document)))
...
(def printer json/null->tree/leaf ()
  (bind ((output-selection (as (print-selection (make-iomap -projection- -recursion- -input- -input-reference- nil)
                                                (get-selection -input-)
                                                'forward-mapper/json/null->tree/leaf)))
         (output (as (tree/leaf (:selection output-selection)
                       (text/text (:selection (as (nthcdr 1 (va output-selection))))
                         (text/string (value-of -input-) :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/blue*))))))
    (make-iomap -projection- -recursion- -input- -input-reference- output)))

(def printer json/boolean->tree/leaf ()
  (bind ((output-selection (as (print-selection (make-iomap -projection- -recursion- -input- -input-reference- nil)
                                                (get-selection -input-)
                                                'forward-mapper/json/boolean->tree/leaf)))
         (output (as (tree/leaf (:selection output-selection)
                       (text/text (:selection (as (nthcdr 1 (va output-selection))))
...
(def printer json/number->tree/leaf ()
  (bind ((output-selection (as (print-selection (make-iomap -projection- -recursion- -input- -input-reference- nil)
                                                (get-selection -input-)
                                                'forward-mapper/json/number->tree/leaf)))
         (output (as (tree/leaf (:selection output-selection)
...
(def printer json/string->tree/leaf ()
  (bind ((output-selection (as (print-selection (make-iomap -projection- -recursion- -input- -input-reference- nil)
                                                (get-selection -input-)
                                                'forward-mapper/json/string->tree/leaf)))
...
(def printer json/array->tree/node ()
  (bind ((element-iomaps (as (recurse-printer -recursion- (elements-of -input-)
                                              `((elements-of (the json/array document))
                                                ,@(typed-reference (document-type -input-) -input-reference-)))))
         (output-selection (as (print-selection (make-iomap/content -projection- -recursion- -input- -input-reference- nil element-iomaps)
                                                (get-selection -input-)
                                                'forward-mapper/json/array->tree/node)))
...
(def printer json/object-entry->tree/node ()
  (bind ((value-iomap (as (recurse-printer -recursion- (value-of -input-)
         ...
         (output-selection (as (print-selection (make-iomap/content -projection- -recursion- -input- -input-reference- nil value-iomap)
                                                (get-selection -input-)
                                                'forward-mapper/json/object-entry->tree/node)))
...
(def printer json/object->tree/node ()
  (bind ((entry-iomaps (as (recurse-printer -recursion- (entries-of -input-)
                                            `((entries-of (the json/object document))
                                              ,@(typed-reference (document-type -input-) -input-reference-)))))
         (output-selection (as (print-selection (make-iomap/content -projection- -recursion- -input- -input-reference- nil entry-iomaps)
                                                (get-selection -input-)
                                                'forward-mapper/json/object->tree/node)))
...
(def reader json/insertion->tree/leaf ()
...
(def reader json/null->tree/leaf ()
  (bind ((operation-mapper (lambda (operation selection child-selection child-iomap)
                             (declare (ignore selection child-selection child-iomap))
                             (typecase operation
...
(def reader json/string->tree/leaf ()
  (bind ((operation-mapper (lambda (operation selection child-selection child-iomap)
                             (declare (ignore child-selection child-iomap))
                             (typecase operation
                               (operation/text/replace-range
...
(def reader json/array->tree/node ()
...
(def reader json/object-entry->tree/node ()
  (bind ((operation-mapper (lambda (operation selection child-selection child-iomap)
                             (declare (ignore child-selection child-iomap))
                             (typecase operation
                               (operation/text/replace-range
                      ...
                      ((make-key-press-gesture :scancode-tab)
                       ...
                       :operation (pattern-case (selection-of -printer-input-)
                                    (((the string (key-of (the json/object-entry document)))
                                     ...
                                     (bind ((command (recurse-reader -recursion- (make-command -gesture- (make-operation/replace-selection (value-of -printer-input-) `((the text/text (content-of (the tree/leaf document)))
                                                                                                                                                                        (the text/text (text/subseq (the text/text document) 0 0))))
                                                                                               :domain "JSON")
                                                                     (content-iomap-of -printer-iomap-)))
...
(def reader json/object->tree/node ()
