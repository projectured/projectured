...
(def printer json/null->string (projection recursion input input-reference output-reference)
  (bind ((output "null")
...
(def printer json/boolean->string (projection recursion input input-reference output-reference)
...
(def printer json/number->string (projection recursion input input-reference output-reference)
...
(def printer json/string->string (projection recursion input input-reference output-reference)
...
(def printer json/array->tree/node (projection recursion input input-reference output-reference)
...
(def printer json/object->tree/node (projection recursion input input-reference output-reference)
  (bind ((typed-input-reference `(the ,(form-type input) ,input-reference))
         (child-iomaps nil)
         (output (make-tree/node (iter (for (key value) :in-hashtable (key-value-map-of input))
                                       ...
                                       (collect (bind ((entry-node-reference `(the tree/node (elt (the list (children-of (the tree/node ,output-reference))) ,index)))
                                                       ...
                                                       (iomap (recurse-printer recursion value
