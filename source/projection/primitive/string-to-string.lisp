  ...
  (pattern-case input-reference
    ((the character (elt (the string ?a) ?b))
     (when (and (equal `(the string ,?a) (input-reference-of iomap))
       ...
       (funcall function iomap `(the character (elt ,(output-reference-of iomap) ,(+ (- ?b (input-offset-of iomap)) (output-offset-of iomap)))))))
    ((the sequence-position (pos (the string ?a) ?b))
     (when (and (equal `(the string ,?a) (input-reference-of iomap))
                (<= (input-offset-of iomap) ?b (+ (input-offset-of iomap) (length-of iomap))))
       (funcall function iomap `(the sequence-position (pos ,(output-reference-of iomap) ,(+ (- ?b (input-offset-of iomap)) (output-offset-of iomap)))))))))
  ...
  (pattern-case output-reference
    ((the character (elt (the string ?a) ?b))
     (when (and (equal `(the string ,?a) (output-reference-of iomap))
       ...
       (funcall function iomap `(the character (elt ,(input-reference-of iomap) ,(+ (- ?b (output-offset-of iomap)) (input-offset-of iomap)))))))
    ((the sequence-position (pos (the string ?a) ?b))
     (when (and (equal `(the string ,?a) (output-reference-of iomap))
                (<= (output-offset-of iomap) ?b (+ (output-offset-of iomap) (length-of iomap))))
       (funcall function iomap `(the sequence-position (pos ,(input-reference-of iomap) ,(+ (- ?b (output-offset-of iomap)) (input-offset-of iomap)))))))))
