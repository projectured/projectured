...
(def printer state-machine/state-machine->tree/node (projection recursion iomap input input-reference)
  ...
  (bind ((typed-input-reference `(the ,(form-type input) ,input-reference))
         ...
         (output (make-tree/node (list (bind ((keyword "state machine"))
                                         (make-tree/leaf (text/make-string keyword :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/blue*)))
                                       (bind ((name (name-of input)))
                                         (make-tree/leaf (text/make-string name :font *font/ubuntu/monospace/bold/24* :font-color *color/solarized/red*)))
                                       (make-tree/node (list (make-tree/node (list* (bind ((label "states:"))
                                                                                      (make-tree/leaf (text/make-string label :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/green*)))
                                                       ...
                                                       :indentation 0))
                                 :separator (text/make-string " " :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/gray*))))
...
(def printer state-machine/state->tree/node (projection recursion iomap input input-reference)
  ...
  (bind ((typed-input-reference `(the ,(form-type input) ,input-reference))
         ...
         (output (make-tree/node (list (bind ((keyword "state"))
                                       ...
                                       (bind ((name (name-of input)))
                                         (make-tree/leaf (text/make-string name :font *font/ubuntu/monospace/bold/24* :font-color *color/solarized/red*))))
                                 :closing-delimiter (text/make-string ";" :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/gray*)
                                 :separator (text/make-string " " :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/gray*))))
    (make-iomap/compound projection recursion input input-reference output
                         (list* (make-iomap/object projection recursion input input-reference output) (nreverse child-iomaps)))))
  ...
  (bind ((typed-input-reference `(the ,(form-type input) ,input-reference))
         ...
         (output (make-tree/node (list (bind ((keyword "transition"))
                                       ...
                                       (make-tree/node (list (bind ((label "event:"))
                                                               (make-tree/leaf (text/make-string label :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/green*) :indentation 2))
                                                             (bind ((event (event-of input)))
                                                               (make-tree/leaf (text/make-string event :font *font/ubuntu/monospace/bold/24* :font-color *color/solarized/red*)
                                                                               :closing-delimiter (text/make-string ";" :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/gray*)))
                                                             (bind ((label "source:"))
                                                               (make-tree/leaf (text/make-string label :font *font/ubuntu/monospace/regular/24* :font-color *color/solarized/green*) :indentation 2))
