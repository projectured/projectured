...
(def function forward-mapper/lisp-form/toplevel->tree/node (printer-iomap reference)
  (bind ((projection (projection-of printer-iomap))
         (recursion (recursion-of printer-iomap)))
    (pattern-case reference
...
(def function backward-mapper/lisp-form/toplevel->tree/node (printer-iomap reference)
  (bind ((printer-input (input-of printer-iomap))
         (projection (projection-of printer-iomap))
         (recursion (recursion-of printer-iomap)))
    (pattern-case reference
...
(def printer lisp-form/toplevel->tree/node (projection recursion input input-reference)
...
(def reader lisp-form/toplevel->tree/node (projection recursion input printer-iomap)
  (declare (ignore projection))
