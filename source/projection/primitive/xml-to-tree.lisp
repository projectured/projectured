...
(def forward-mapper xml/insertion->tree/leaf ()
...
(def forward-mapper xml/text->tree/leaf ()
  (pattern-case -reference-
...
(def forward-mapper xml/attribute->tree/node ()
  (pattern-case -reference-
...
(def forward-mapper xml/element->tree/node ()
  (pattern-case -reference-
...
(def backward-mapper xml/insertion->tree/leaf ()
  (pattern-case -reference-
    (((the text/text (content-of (the tree/leaf document)))
      (the text/text (text/subseq (the text/text document) 0 0)))
     `((the string (value-of (the xml/insertion document)))
...
(def backward-mapper xml/text->tree/leaf ()
  (pattern-case -reference-
    (((the tree/leaf document))
     '((the xml/text document)))
    (((the text/text (content-of (the tree/leaf document)))
...
(def backward-mapper xml/attribute->tree/node ()
  (pattern-case -reference-
    (((the tree/node document))
     '((the xml/attribute document)))
    (((the sequence (children-of (the tree/node document)))
...
(def backward-mapper xml/element->tree/node ()
...
(def printer xml/element->tree/node ()
...
(def reader xml/insertion->tree/leaf ()
...
(def reader xml/attribute->tree/node ()
  (bind ((operation-mapper (lambda (operation selection child-selection child-iomap)
                             (declare (ignore child-selection child-iomap))
                             (typecase operation
                               (operation/text/replace-range
...
(def reader xml/element->tree/node ()
  (bind ((operation-mapper (lambda (operation selection child-selection child-iomap)
                             (declare (ignore child-selection child-iomap))
                             (typecase operation
                               (operation/text/replace-range
