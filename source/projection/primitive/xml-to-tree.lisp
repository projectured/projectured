         ...
         (output (tree/leaf (:selection output-reference)
                   (text/text (:selection (butlast output-reference))
                     (if (zerop (length text))
                         (text/string "Enter text here" :font *font/ubuntu/monospace/regular/18* :font-color (color/lighten *color/solarized/green* 0.75))
                         (text/string text :font *font/ubuntu/monospace/regular/18* :font-color *color/solarized/green*))))))
